...
import (
	...
	"github.com/TanatipWa/product-api/crud"
...
func (cuc *CrudUseCase) InsertDataUC(ctx context.Context, req entity.DataProductRequest) (resp bool, err error) {
...
func (cuc *CrudUseCase) UpdateDataUC(ctx context.Context, req entity.DataProductRequest) (resp bool, err error) {
	//check if context is nil
	if ctx == nil {
		ctx = context.Background()
	}
...
func (cuc *CrudUseCase) DeleteDataUC(ctx context.Context, req entity.DataProductRequest) (resp bool, err error) {
	//check if context is nil
	if ctx == nil {
		ctx = context.Background()
	}
